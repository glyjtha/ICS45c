...
TEST(StringFunction, strdup) {
    ...
    char* duplicated1 = String::strdup(source1);
    EXPECT_STREQ(duplicated1, source1);
    delete[] duplicated1; 

    char* duplicated2 = String::strdup(source2);
    EXPECT_STREQ(duplicated2, source2);
    delete[] duplicated2; 

    char* duplicatedEmpty = String::strdup(empty);
    EXPECT_STREQ(duplicatedEmpty, empty);
    delete[] duplicatedEmpty; 
}
